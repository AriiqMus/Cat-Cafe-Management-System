<%-- 
    Document   : StaffMainPage
    Created on : 16 Jun 2025, 4:30:52 pm
    Author     : sitif
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="admin-greeting">
            <h2>Welcome, Staff! 🐾</h2>
            <p>Manage daily operations below</p>
        </div>
        ...
        <div class="dashboard-grid">
            ...
            <div class="card">
                ...
                <p>Update Customer Order</p>
                <a href="staffOrderList.jsp">Go to Menu</a>
            </div>
        </div>
        ...
        <div id="catModal" class="modal">
            <div class="modal-content">
                ...
                <a href="CatProfileServlet">🐱 Cat Profiles</a>
